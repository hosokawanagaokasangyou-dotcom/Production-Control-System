...
set "PM_AI_JFX_MODPATH=%ROOT%\app\javafx-base-26.0.1-win.jar;%ROOT%\app\javafx-controls-26.0.1-win.jar;%ROOT%\app\javafx-fxml-26.0.1-win.jar;%ROOT%\app\javafx-graphics-26.0.1-win.jar;%ROOT%\app\javafx-swing-26.0.1-win.jar;%ROOT%\app\javafx-web-26.0.1-win.jar"

...
function Copy-WorkspaceTreeWithExplicitExclusions {
    ...
    # Directory base names matched anywhere in the path (caches / build outputs).
    $excludedDirNames = @(
        '__pycache__',
        '.pytest_cache',
        'build_cache'
...
function Copy-BundleToDist {
    ...
    @(
        ...
        'Excluded dirs: .git, .venv, code_java/{target,package_input,dist,output,Cash_PMD}, **/build_cache, **/__pycache__, **/.pytest_cache.',

...
fast_package_app.ps1 bundles pm-ai-data using git ls-files and .gitignore. Run from a Git checkout.
'@
    }
...
function Copy-BundleToDist {
    ...
    @(
        ...
        'Also excludes packaging dirs: code_java/Cash_PMD, package_input, PMD_fast.',

# -*- coding: utf-8 -*-
"""
段�?1/2: logging 出力を xlwings 経由で Excel の UserForm?�?txtExecutionLog?��へ追記する�?

有効条件:
  - 環�?変数 PM_AI_SPLASH_XLWINGS=1?�?VBA の .cmd で set?�?
  - TASK_INPUT_WORKBOOK にマクロブックのフルパス?��既に Excel で開いて�?ること?�?
  - 標準モジュールに Public Sub SplashLog_AppendChunk(ByVal chunk As String)?��名前変更時�?� PM_AI_XLWINGS_SPLASH_MACRO=モジュール�?.マクロ名�?
...
def _macro_qualified_name() -> str:
    return (os.environ.get("PM_AI_XLWINGS_SPLASH_MACRO") or "�X�v���b�V�����O_�`�����N��ǋL").strip()
